...
// Blink channel lights while update pending
// DONE - Blink Status light while sending update?
// Make connecting to wifi not loop forever
// Check returned body from posting channel status
...
// time server sync?
// send which channels change on update
